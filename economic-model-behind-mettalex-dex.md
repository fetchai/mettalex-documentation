...
**Note**: For more information on the available markets on Mettalex DEX, visit the "[Markets Available on Mettalex DEX Vega](markets-available-on-mettalex-dex-vega.md)" section.
